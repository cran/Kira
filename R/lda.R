lda <- function(data, test = NA, class = NA, type = "train", 
                method = "moment", prior = NA) {

  # Esta funcao executa a Analide resultriminante linear
  ...
  result <- MASS::lda(class~., data, prior = prior, method = method, subset = train)
